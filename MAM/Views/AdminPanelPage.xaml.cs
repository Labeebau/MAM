...
namespace MAM.Views
{
	...
	public sealed partial class AdminPanelPage : Page
	{
		...
		private readonly List<(string Tag, Type Page)> _pages = new List<(string Tag, Type Page)>
		{
			...
			("MailSettings",typeof(MailSettingsPage)),
			("UserGroups",typeof(UserGroupsPage)),
			("Users",typeof(UsersPage)),
			("AuthorizationSettings",typeof(AuthorizationSetingsPage)),
			("MetaData",typeof(MetadataPage)),
            ("ProcessServer",typeof(ProcessServerPage)),
            ("FileServer",typeof(FileServerPage)),
            ("ArchiveServer",typeof(ArchiveServerPage)),
            ("TargetLocations",typeof(TargetLocationsPage)),
            ("RSSList",typeof(RSSListPage))
		...
		private void navAdmin_Loaded(object sender, RoutedEventArgs e)
		{
			...
			//navAdmin_Navigate("HomePage", new EntranceNavigationTransitionInfo());
		}
